...
private:
	...
	FlightDataParser();						// Default constructor (private for singleton design purposes)
public:
	~FlightDataParser();					// Destructor
	int getInstanceNumber();                // Return how many instances of this class there are
	static FlightDataParser* getInstance(); // Return the instance of a FlightDataParser object. Should always return the same object
